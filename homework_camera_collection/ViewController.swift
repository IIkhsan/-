...
class ViewController: UIViewController {
    ...
    private func configureMapView() {
        ...
        let coordinates = CLLocationCoordinate2D(latitude: 55.7902975, longitude: 49.1440196)
    ...
    private func addAnnotation(image: UIImage) {
        ...
        pins.append(.init(image: image, date: Date().formatted(), coordinates: center.latitude.description + ", " + center.longitude.description))
...
extension ViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configure(pins[indexPath.row])
        return cell
    }
}
