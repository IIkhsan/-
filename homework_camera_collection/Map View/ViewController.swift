...
class ViewController: UIViewController {
    ...
    private let layout = CollectionFlowLayout()
    private var photoCell: [PhotoInfo] = []
    ...
    private func configureMapView() {
        ...
        let coordinate = CLLocationCoordinate2D(latitude: 55.796127, longitude: 49.106414)
    ...
    private func addAnnotation(image: UIImage) {
        ...
        photoCell.append(PhotoInfo(image: image, date: Date().formatted(), coordinate: "\(mapView.centerCoordinate.latitude), \(mapView.centerCoordinate.longitude)"))
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(UINib(nibName: "PhotoCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: PhotoCollectionViewCell.identifier)
...
extension ViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: PhotoCollectionViewCell.identifier, for: indexPath) as? PhotoCollectionViewCell else { fatalError("Photo cell cannot be dequeue")}
        cell.configure(with: photoCell[indexPath.item])
        if indexPath.item == 0 { transform(cell) }
        return cell
    }
}
